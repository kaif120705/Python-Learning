...
print("==" * 25)
#======================================================================================
# Converting Str int data into int is possible else not possible in any other data type
#======================================================================================
a="1234"
print(int(a))
#a="26.78"
...
print("==" * 25)
#=================================================
# Conversion of float to other Possible type Value
#=================================================
a=25
print(float(a))
a=0
...
print(bool(a))
#================================================================
# IMP POINT : if there is Space in Str then gives TRUE else False
#================================================================
a=" "
print(a,bool(a))
a=""
...
print(complex(a))
#============================================================
# Converting complex data type to Comlex is not possible
#a=2+4i
#print(a,type(a))
#print(complex(a))
#============================================================
